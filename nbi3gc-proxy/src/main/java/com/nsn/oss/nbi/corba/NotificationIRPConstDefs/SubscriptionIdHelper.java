...
/**
 * Generated from IDL alias "SubscriptionId".
 *
...
public final class SubscriptionIdHelper {
    ...
    public static org.omg.CORBA.TypeCode type() {
        if (_type == null) {
            synchronized (SubscriptionIdHelper.class) {
                if (_type == null) {
                    _type =
                        org.omg.CORBA.ORB.init()
                            .create_alias_tc(com.nsn.oss.nbi.corba.NotificationIRPConstDefs.SubscriptionIdHelper.id(),
                                             "SubscriptionId", org.omg.CORBA.ORB.init().create_string_tc(0));
                }
            }
        }
        return _type;
