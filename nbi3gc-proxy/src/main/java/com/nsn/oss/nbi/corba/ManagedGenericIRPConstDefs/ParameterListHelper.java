...
public final class ParameterListHelper {
                ...
                if (_type == null) {
                    _type =
                        org.omg.CORBA.ORB.init()
                            .create_alias_tc(com.nsn.oss.nbi.corba.ManagedGenericIRPConstDefs.ParameterListHelper.id(),
    ...
    public static String id() {
        return "IDL:3gppsa5.org/ManagedGenericIRPConstDefs/ParameterList:1.0";
    }
