...
public final class NotificationTypesSetHelper {
    ...
    public static org.omg.CORBA.TypeCode type() {
        if (_type == null) {
            synchronized (NotificationTypesSetHelper.class) {
                if (_type == null) {
                    _type =
                        org.omg.CORBA.ORB.init().create_alias_tc(
                            com.nsn.oss.nbi.corba.NotificationIRPConstDefs.NotificationTypesSetHelper.id(),
                            "NotificationTypesSet", org.omg.CORBA.ORB.init().create_sequence_tc(0,
    ...
    public static String id() {
        return "IDL:3gppsa5.org/NotificationIRPConstDefs/NotificationTypesSet:1.0";
    }
    ...
    public static java.lang.String[][] read(final org.omg.CORBA.portable.InputStream _in) {
        ...
        for (int i = 0; i < _result.length; i++) {
            _result[i] =
                com.nsn.oss.nbi.corba.NotificationIRPConstDefs.NotificationTypePerNotificationCategoryHelper.read(_in);
        }
