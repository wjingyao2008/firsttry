...
public final class GetSubscriptionIdsHelper {
    ...
    public static org.omg.CORBA.TypeCode type() {
        if (_type == null) {
            synchronized (GetSubscriptionIdsHelper.class) {
                if (_type == null) {
                    _type =
                        org.omg.CORBA.ORB.init().create_exception_tc(
                            com.nsn.oss.nbi.corba.NotificationIRPSystem.GetSubscriptionIdsHelper.id(),
                            "GetSubscriptionIds", new org.omg.CORBA.StructMember[]{
    ...
    public static void insert(final org.omg.CORBA.Any any,
                              final com.nsn.oss.nbi.corba.NotificationIRPSystem.GetSubscriptionIds s) {
        any.type(type());
        write(any.create_output_stream(), s);
    }

    public static com.nsn.oss.nbi.corba.NotificationIRPSystem.GetSubscriptionIds extract(final org.omg.CORBA.Any any) {
    ...
    public static com.nsn.oss.nbi.corba.NotificationIRPSystem.GetSubscriptionIds read(
        ...
        java.lang.String x0;
        x0 = in.read_string();
        final com.nsn.oss.nbi.corba.NotificationIRPSystem.GetSubscriptionIds
            result =
            new com.nsn.oss.nbi.corba.NotificationIRPSystem.GetSubscriptionIds(id, x0);
        return result;
    }
