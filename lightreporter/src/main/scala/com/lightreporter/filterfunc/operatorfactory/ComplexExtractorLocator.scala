...
class ComplexExtractorLocator[T1, T2](val valueExtractorMap1: ExtractorLocator[T1],
                                      val valueExtractorMap2: ExtractorLocator[T2] = null) extends ExtractorLocator[T1] {

  val log = Logger.getLogger(classOf[ComplexExtractorLocator[T1, T2]])
...
//    }
    throw new UnsupportedOperationException(s"can't find combined dot value selector array:")
  }
